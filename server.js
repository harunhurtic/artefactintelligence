...
app.post("/fetch-description", async (req, res) => {
    ...
    try {
        ...
        let prompt = `Adapt the following artefact description in ${language} and make it more engaging for a museum visitor with the "${profile}" profile, while preserving the length and factual accuracy. Ensure that the adaptation aligns with the preferences, interests, and motivations of their profile, without explicitly mentioning their profile or adding unnecessary details.\n\nArtefact: "${artefact}".\nDescription: "${originalDescription}"`;
